...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:/tmp/amassiro/prova_for_bbhgg.root')
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('/tmp/amassiro/provaGENSIM_bbHGG.root'),
    fileName = cms.untracked.string('/tmp/amassiro/GENSIM_bbHGG.root'),
